    ...
    <div v-if="isOpen" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
        <div class="bg-white rounded-lg p-6 w-full max-w-lg">
            <div class="flex justify-between items-center mb-4">
                <h3 class="text-lg font-semibold">Modifier le Post</h3>
            ...
            <div v-if="editedPost" class="mb-4">
                ...
                <div v-if="editedPost.type === 'image' || editedPost.type === 'video'">
                    ...
                    />
                    <p v-if="editedPost.content.file" class="mt-2 text-sm text-gray-600">
                        Fichier sélectionné : {{ editedPost.content.file.name }}
                    </p>
                    <textarea
            ...
            <div class="flex justify-end gap-2">
                <button @click="onClose" class="bg-gray-300 text-black py-2 px-4 rounded-lg">
                    Annuler
                </button>
...
export default {
    ...
    watch: {
        post: {
            ...
            handler(newPost) {
                if (newPost) {
                    this.editedPost = JSON.parse(JSON.stringify(newPost));
                }
            }
        }
    },
    ...
    methods: {
        handleFileUpload(event) {
            this.editedPost.content.file = event.target.files[0];
        },
        resetPostContent() {
